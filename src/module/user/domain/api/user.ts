...
export class UserApi {
    ...
    static async getUsersPublic(filter: UserPublicFilterDTO) {
        return await requester.call<{ pagination: Pagination; users: UserPublicDTO[] }>({
            handleData: (data: GetUsersPublicDTO) => {
                return data.data;
            }
        })(UserEndpoint.getUsersPublic(filter));
    }
