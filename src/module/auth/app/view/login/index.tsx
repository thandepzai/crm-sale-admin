        ...
        <div className="flex items-center text-secondary-typo tabx:px-10 lap:px-40">
          <div className="hidden tabx:flex flex-col justify-center items-center basis-1/2 lap:pr-32 border-r border-r-[#DCECFC]">
            <div className="w-full mb-8">
              <h2 className="text-[2.5rem] font-bold mb-2">
                Chào mừng trở lại
              </h2>
              <p className="text-md w-80">
                Học tập và giao lưu với hàng triệu học viên trên mọi miền đất
                nước.
              </p>
            </div>
          ...
          <div className="w-full basis-1/2 tabx:pl-14 lap:pl-32 flex flex-col flex-center min-w-[350px]">
            ...
            <Form.Item
              ...
              className="w-full"
              rules={[
                { required: true, message: strings.input_required_error },
              ]}
            >
