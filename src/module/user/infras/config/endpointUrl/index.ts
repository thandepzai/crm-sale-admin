import { UserPublicFilterDTO, UserFilterDTO } from "module/user/domain/dto/user";
...
export class UserEndpoint extends MapstudyEndpoint {
    ...
    static getUsersPublic = (filter: UserPublicFilterDTO) => `${this.base}/v1/public-user?${this.extractQuery(filter)}`;
